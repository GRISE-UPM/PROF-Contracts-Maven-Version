...
public enum CourseDataValuesTest implements CourseData {
	...
	INCORRECT_DEGREE_COURSE_MORE_CREDITS ("DEGREE", "Correct degree course", 8),
	INCORRECT_MASTER_COURSE ("MASTER", "Correct degree course", 5),
	INCORRECT_MASTER_COURSE_MORE_CREDITS("MASTER", "Correct degree course", 8),
	CORRECT_MASTER_COURSE ("MASTER", "Correct degree course 1", 1),
